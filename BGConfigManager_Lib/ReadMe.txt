========================================================================
    정적 라이브러리 : BGConfigManager_Lib 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 BGConfigManager_Lib 라이브러리 프로젝트를 만들었습니다.

프로젝트에 대해 소스 파일은 만들어지지 않았습니다.


BGConfigManager_Lib.vcxproj
...
BGConfigManager_Lib.vcxproj.filters
